...
public class GooglePlusLoginActivity extends FragmentActivity implements
	...
	/*
	 * private Runnable mLaunchTask = new Runnable() { public void run() {
	 * Intent mainIntent = new Intent(getApplicationContext(),
	 * MainActivity.class); mainIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("cannot Eli");
/*		
		try {
			Bundle extras = getIntent().getExtras();
			// Intent getIntent = new Intent();
			int int_condition = extras.getInt("your_condition");
			if (int_condition == 1) {
				// Call the method
				...
				// method you want
				System.out.println("cannot singout");
			}
...
// mHandler.postDelayed(mLaunchTask, 4000);
		Intent mainIntent = new Intent(getApplicationContext(),
				MainActivity.class);
